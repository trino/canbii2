...
<html>
    ...
    <body>
        ...
        <table width="100%" align="center">
            <tr>
                <td style="text-align:left;font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; " valign="middle">
                    <A href="<?= $url; ?>"><img src="http://canbii.com/HiResLogoMedium1.png" width="200px"><span style="text-align: right;"></A>
            ...
            <tr>
                <td align="center" style="padding-left: 45px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif'; text-align:left; font-size:16px; ">
                    <p>
                        <a href="<?= $url; ?>" style="text-decoration: none; color: #243466; font-weight: 500;">Home</a> |
