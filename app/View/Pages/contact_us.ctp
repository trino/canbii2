                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input name="name" type="text" id="name" class="form-control  form-control--contact" required value="<?= $username; ?>">
                        </div>
                        <div class="form-group">
                            <label class="text-dark" for="email">E-mail <span class="bluecolor">*</span></label>
                            <input name="email" type="email" required="required" id="email" class="form-control  form-control--contact" value="<?= $email; ?>" >
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-4 col-md-4" style="margin-left: 0;">
                        <div class="form-group">
