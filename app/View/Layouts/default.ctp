        ...
        <ul>
            <li>
                ...
                <p style="color: white;margin-bottom:20px;">
                    <a style="font-size:13px;" href="<?= $this->webroot ?>pages/about">The guide to Medical Cannabis
                        &raquo;</a>
                </p>
            </li>
            <li>
                ...
                <p style="color: white;margin-bottom:20px;">
                    <a style="font-size:13px;" href="<?= $this->webroot ?>users/register">The more we know, the more we
                        can help &raquo;</a>
                </p>
            </li>
            <li>
                ...
                <p style="color: white;margin-bottom:20px;">
                    <a style="font-size:13px;" href="<?= $this->webroot ?>pages/contact_us">Feel free to contact us by
                        clicking here &raquo;</a>
                </p>
            </li>
        </ul>
        <div>
            <div>
                ...
                <p style="color: #D5D5D5;">
                    ...
                    <br/>
                    <br/>
                    Please do your part in helping the world's largest clinical trial so that we can better understand
                    the use and effects of the cannabis plant.
                </p>
            ...
            <div>
                <div>
                    ...
                    <!--<div >
                        <a href="#" id="footer_recent_posts_prev" ></a>
                        <a href="#" id="footer_recent_posts_next" ></a>
                    </div>-->
                </div>
                <div>
                    <ul>
            ...
            <div>
                <div>
                    ...
                    <div>
                        <!--a href="#" id="latest_tweets_prev" ></a>
                        <a href="#" id="latest_tweets_next" ></a-->
                    </div>
                </div>
                <div>
