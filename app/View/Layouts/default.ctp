                    ...
                    <DIV CLAS="row">
                        <nav class="navbar navbar-expand-lg navbar-light bg-light col-lg-12 col-md-12 col-sm-12 col-xs-6">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <form class="form-inline col-lg-3 col-md-12 col-sm-12 col-xs-12 no-wrap">
                                    <input class="form-control col-lg-9 col-md-9 col-sm-9 col-xs-5" type="search" placeholder="Search" aria-label="Search">
                                    <button class="btn btn-outline-success col-lg-2 col-md-2 col-sm-2 col-xs-1" type="submit" ID="searchbtn"><i class="fa fa-search"></i></button>
                                </form>
                            </div>
                        </nav>
                    </DIV>
