...
jQuery(document).ready(function($){
	...
	$(".contact_form2 .tabs_box_navigation a").click(function(event){
	...
	$(".contact_form2").submit(function(event){
		...
		$.ajax({
			url: $(".contact_form2").attr("action"),
			data: data,
			type: "post",
			dataType: "json",
			success: function(json){
				$("#contact_form2 [name='submit'], #contact_form2 [name='first_name'], #contact_form2 [name='last_name'], #contact_form2 [name='email'], #contact_form2 [name='message']").qtip('destroy');
				if(typeof(json.isOk)!="undefined" && json.isOk)
				{
					if(typeof(json.submit_message)!="undefined" && json.submit_message!="")
					{
						$("#contact_form2 [name='submit']").qtip(
						{
							style: {
						...
						$(".contact_form2")[0].reset();
						$(".contact_form2 [name='department']").val("");
						$(".contact_form2 .tabs_box_navigation_selected>span").text("Select department");
					}
				}
				else
				{
					...
					{
						$("#contact_form2 [name='first_name']").qtip(
						{
							style: {
								classes: 'ui-tooltip-error'
							},
					...
					{
						$("#contact_form2 [name='last_name']").qtip(
						{
							style: {
								classes: 'ui-tooltip-error'
							},
					...
					{
						$("#contact_form2 [name='message']").qtip(
						{
							style: {
								classes: 'ui-tooltip-error'
							},
	...
	$(".contact_form2 [name='date_of_birth']").datepicker({
		dateFormat: "mm-dd-yy"
	});
