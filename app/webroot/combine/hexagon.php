<SPAN debugtitle="combine/hexagon.php">
    <?php
        ...
        switch ($strain_hexagon['Strain']['type_id']) {
            ...
            case 3: $background_hex = $this->webroot . "images/Hybrid.png"; break;
        }
    ?>
    ...
    <div class="printer" style="margin-right:12px;text-align: center; float:left;width:57px;height:66px;background-repeat: no-repeat;">
        <div class="printer" style="height:66px; width:57px; text-align:center; display: table-cell; vertical-align:middle; background: url('<?= $background_hex ?>') no-repeat !important;">
            <p class="printer" style="margin-top:15px;color: #FFF; font-size: 18px; z-index: 100;color:#FFF;">
                <?php
