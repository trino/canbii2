<SPAN debugtitle="combine/strains.php">
    <div class="page_margin_top" style="text-align: center;  padding: 20px 30px 20px 30px; line-height: 150%;background: #42B3E5;">
    ...
    <ul class="columns_3 page_margin_top clearfix">
        <li class="column">
            ...
            <a title="Browse Strains" href="<?= $this->webroot; ?>strains/all/indica" class="more blue">
                Indica Strains →
            </a>
        </li>
        ...
        <li class="column">
            ...
            <a title="Browse Strains" href="<?= $this->webroot; ?>strains/all/sativa" class="more blue">
                Sativa Strains →
            </a>
        </li>
        ...
        <li class="column">
            ...
            <a title="Browse Strains" href="<?= $this->webroot; ?>strains/all/hybrid" class="more blue">
                Hybrid Strains →
            </a>
        </li>
    </ul>
